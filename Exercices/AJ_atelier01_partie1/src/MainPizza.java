...
public class MainPizza {
	...
	public static void main(String[] args) {
		...
		ingredients.add(Ingredients.PARMESAN);
		try {
			new PizzaComposee("4 fromages", "le mélange généreux des formages italiens", ingredients);
		} catch (IllegalArgumentException e){
			System.out.println(e.getMessage());
		}
		System.out.println();
		ingredients.remove(Ingredients.PARMESAN);
		Pizza p_4fromages = new PizzaComposee("4 fromages", "le mélange généreux des formages italiens", ingredients);
