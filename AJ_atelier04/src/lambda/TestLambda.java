...
public class TestLambda {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n**** TEST MÉTHODES allMatches ET transformAll ****\n");
        ...
        result = Lambda.allMatches(list, e -> Integer.parseInt(e.toString().substring(0, 1)) == 1);
        System.out.println(result);
        ...
        System.out.println("\n**** TEST MÉTHODES filter ET map ****\n");

        // ! Test pour les méthodes filter et map
        ...
        //Trouve tous les entiers de la liste dont le premier chiffre est 1
        result = Lambda.filter(list, e -> Integer.parseInt(e.toString().substring(0, 1)) == 1);
        System.out.println(result);
        ...
        //Trouve toutes les String de la liste qui commencent par "h"
        List<String> result4 = Lambda.filter(list2, e -> e.charAt(0) == 'h');
        System.out.println(result2);
