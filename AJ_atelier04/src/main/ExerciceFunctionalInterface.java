...
public class ExerciceFunctionalInterface {
    ...
    // pour savoir le type de la méthode .map -> cmd + clic droit
    ...
    private static void exForEach(){
        employes.forEach(new ConsumerExForEach());
    }

    // pour savoir le type de la méthode .forEach -> cmd + clic droit
    // default void forEach(Consumer<? super T> action) {
    private static class ConsumerExForEach implements Consumer<Employe> {
        @Override
